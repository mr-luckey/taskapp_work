              ...
              SizedBox(
                ...
                child: ValueListenableBuilder<Box<taskModel>>(
                  ...
                  builder: (context, box, _) {
                    ...
                    // Filter tasks by "Office" tag and search query
                    var filteredTasks = data.where((task) {
                      final matchesTag = task.tags.contains("Office");
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          child: CustomDecoratedText(
                            ...
                            containerColor: DailozColor.bgpurple,
                            tags: task.tags,
                            tagTextColor: DailozColor.purple,
                            tagBackgroundColor: const Color(0xffECEAFF),
                          ),
                        );
                      },
                    );
