              ...
              SizedBox(
                ...
                child: ValueListenableBuilder<Box<taskModel>>(
                  ...
                  builder: (context, box, _) {
                    ...
                    // Filter tasks by "Work" tag and search query
                    var filteredTasks = data.where((task) {
                      final matchesTag = task.tags.contains('Work');
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          child: CustomDecoratedText(
                            ...
                            containerColor: DailozColor.bgsky,
                            tags: task.tags,
                            tagTextColor: DailozColor.textblue,
                            tagBackgroundColor: const Color(0x2637C5FF),
                          ),
                        );
                      },
                    );
