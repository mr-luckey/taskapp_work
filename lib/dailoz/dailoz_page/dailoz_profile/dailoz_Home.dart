...
// class DailozPrivate extends StatefulWidget {
//   const DailozPrivate({Key? key}) : super(key: key);

//   @override
//   State<DailozPrivate> createState() => _DailozPrivateState();
// }

// class _DailozPrivateState extends State<DailozPrivate> {
//   dynamic size;
//   double height = 0.00;
//   double width = 0.00;
//   @override
...
//                             tagTextColor:
//                                 DailozColor.lightred, // Set the tag text color
              ...
              SizedBox(
                ...
                child: ValueListenableBuilder<Box<taskModel>>(
                  ...
                  builder: (context, box, _) {
                    ...
                    // Filter tasks by "Home" tag and search query
                    var filteredTasks = data.where((task) {
                      final matchesTag = task.tags.contains('Home');
